...
Follow the [stable setup guide](setup.md) to configure and reload Hammerspoon, then add a Hammerspoon Button, Toggle, or keypad-only Multi-State action in Stream Deck.
