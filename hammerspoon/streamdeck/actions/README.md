...
| `pomodoro`             | `com.brettinternet.hammerspoon.pomodoro`             | Toggle         | Press pauses or resumes the focus schedule, hold resets it, and an optional sound marks phase completion.                   |
