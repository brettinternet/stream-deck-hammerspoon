...
| `application`          | `com.brettinternet.hammerspoon.application-toggle`   | Toggle         | Hides, shows, focuses, or closes a configured application; shows its macOS icon with green, yellow, or red window-state indicator; without a bundle ID it follows the frontmost application. |
