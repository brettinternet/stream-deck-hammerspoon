...
| `spotify`              | `com.brettinternet.hammerspoon.spotify`              | Button / Dial  | Shows album artwork and toggles play/pause; add it to two dials and select Volume or Previous / next track for each.        |
