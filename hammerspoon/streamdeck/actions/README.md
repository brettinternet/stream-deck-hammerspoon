...
| `microphone`           | `com.brettinternet.hammerspoon.microphone-toggle`    | Toggle / Pedal | Toggles a selected input, provides push-to-talk, or combines tap-to-toggle with hold-to-talk; follows external input mute changes and can send per-app Zoom, Teams, and Slack mute shortcuts. |
