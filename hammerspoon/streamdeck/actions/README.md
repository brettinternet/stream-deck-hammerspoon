...
| `url-toggle`           | `com.brettinternet.hammerspoon.url-toggle`           | Button         | Opens the configured URL in a new Chromium window by default, or a new tab in the frontmost window when configured; closes its existing tab. Requires Chromium automation permission. |
