...
| `focus-timer`          | `com.brettinternet.hammerspoon.focus-timer`          | Toggle         | Starts or cancels a 25-minute timer independently for each key, with a live countdown and progress bar.                     |
