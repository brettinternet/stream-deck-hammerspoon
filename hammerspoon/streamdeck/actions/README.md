...
| `url-toggle`           | `com.brettinternet.hammerspoon.url-toggle`           | Button         | Opens the configured URL in Chromium, or closes its existing tab. Requires Chromium automation permission.                  |
