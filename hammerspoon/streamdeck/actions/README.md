...
| `microphone`           | `com.brettinternet.hammerspoon.microphone-toggle`    | Toggle / Pedal | Toggles a selected input or provides push-to-talk, follows external input mute changes, and can send per-app Zoom, Teams, Slack, and Discord mute shortcuts. |
